					...
					<!-- <form action="" method="POST"> -->
                        <table class="cart_items">
							...
							<tr>
								...
								<td><?php echo $key ++; ?></td>
                                <td><img src="img/product/<?php echo $value['image']; ?>"></td>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="check_out_simble review_button">
                        <a href="check.php"><button type="submit" title="Submit Review" class="button">Thanh toán</button></a>
