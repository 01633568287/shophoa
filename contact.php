            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="get_touch">
                        ...
                        <p>We possess within us two minds. So far I have written only of the conscious mind. I would now like to introduce you to your second mind, the hidden and mysterious subconscious. Our subconscious mind contains such power and complexity
                            that it literally staggers the imagination.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="contact_us_info">
                        <form action="" method="POST">
                            <table>
                                ...
                                <input type="text" placeholder="Subject" name="tieu_de">
                                <textarea placeholder="Message *" rows="10" cols="30" name="noi_dung"></textarea>
                                <div class="controls">
