                    ...
                    <div class="right col-md-5 col-lg-5 col-xl-6">
                        <div class="t">
                            ...
                            <table style="width:90%">
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $value['id'];?> * <?php echo $value['qty'];?></td>
                                ...
                                <tr>
                                    <td>Tạm tính</td>
                                    <td class="hai"><?php echo $sub_total;?></td>
                                </tr>
...
switch ($action){
	case 'ins': 
        ...
        $oid=$row['id'];
        $sql1="INSERT INTO `orders_detail`(`orders_id`, `product`, `price`, `qty`, `thanhtien`) VALUES ($oid,$id,$price,$qty,$sub_total)";
        Query($sql1);
        session_destroy();
