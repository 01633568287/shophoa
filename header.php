					...
					<div class="col-md-12">
						...
						<div class="main_menu">
							<ul id="nav_menu" class="active_cl">
								...
								<li><a href="shop.php"><span class="Clothings">Cửa hàng</span></a>
									<div class="mega_menu_list">
										<!-- <div class="single_megamenu">
											<h2><a href="shop.php">Learning</a></h2>
											<div class="items_list">
												<a href="shop.php"><i class="fa fa-angle-right"></i>Carnation</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Daisy</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Rose</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Gladiolus</a>
											</div>
										</div>
										<div class="single_megamenu">
											<h2><a href="shop.php">Lighting</a></h2>
											<div class="items_list">
												<a href="shop.php"><i class="fa fa-angle-right"></i>Carnation</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Daisy</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Rose</a>
										...
										<div class="single_megamenu">
											<h2><a href="shop.php">Living Room</a></h2>
											<div class="items_list">
												<a href="shop.php"><i class="fa fa-angle-right"></i>Carnation</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Daisy</a>
												<a href="shop.php"><i class="fa fa-angle-right"></i>Rose</a>
								...
								<li><a href="shop.php"><span class="Accessaries">Trang khác</span></a>
									<div class="home_mega_menu">
