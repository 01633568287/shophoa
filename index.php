                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single_image">
                        ...
                        <div class="shop_collection">
                            <a href="shop.php">Shop the Collection <span><img src="img/arrow/bkg_newsletter.png" alt="" /></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
?>
    ...
    <div class="feature_area">
        <div class="container">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <form action="" method="GET" name="form" enctype="multipart/form-data">
                        <div class="single_product">
                            <a href="product.php?id=<?php echo $row['product_id']?>" target="main"><img src="img/product/<?php echo $image ?>" alt="" /></a>
            ...
            // switch($action) {
            //     case 'insert':
            //         //INSERT INTO `order_products` (`order_id`,`product_id`,`qty`,`amt`) VALUES ('1',$row['product_id'],'1',$price);
            //         $sql="INSERT INTO `order_products` (`order_pro_id`, `order_id`, `product_id`, `qty`, `amt`) VALUES ('',1,$product_id,1,$price)";
            //         query($sql);
            //     break;
            // }
            ?>
